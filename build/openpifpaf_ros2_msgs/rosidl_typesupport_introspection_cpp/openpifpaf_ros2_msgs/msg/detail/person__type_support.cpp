...
{
  new (message_memory) openpifpaf_ros2_msgs::msg::Person(_init);
}

void Person_fini_function(void * message_memory)
{
  auto typed_message = static_cast<openpifpaf_ros2_msgs::msg::Person *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Person_message_member_array[3] = {
  {
    ...
    offsetof(openpifpaf_ros2_msgs::msg::Person, markers),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(openpifpaf_ros2_msgs::msg::Person, person_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(openpifpaf_ros2_msgs::msg::Person, human_person_num),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Person_message_members = {
  ...
  "Person",  // message name
  3,  // number of fields
  sizeof(openpifpaf_ros2_msgs::msg::Person),
...
{
  return &::openpifpaf_ros2_msgs::msg::rosidl_typesupport_introspection_cpp::Person_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, openpifpaf_ros2_msgs, msg, Person)() {
  return &::openpifpaf_ros2_msgs::msg::rosidl_typesupport_introspection_cpp::Person_message_type_support_handle;
}
